...
def make_classification_ans_ensemble_selected_models(data, name, models='p',tagNum=6):
...
if __name__ == '__main__':
    ...
    if status == 'train':
        ...
        out_predict, _ = make_classification_ans_ensemble_selected_models(data, 'test', models='f')
