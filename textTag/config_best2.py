...
class Config(object):
    ...
    question_train_set_items = 650243
    '''
    ...
    vocab_size = 127985  # num of words
    ...
    embedding_path = 'char_embedding_enhance2.npz'  # Embedding
    train_data_path = 'train_enhance2.npz'  # train
    labels_path = 'labels_enhance2.json'  # labels
    test_data_path = 'test_enhance2.npz'  # test
    ...
    #ensemble
    ensemble_outfile = 'ensemble2_default.csv'
    ...
    model_num = 7
    data_root = ""
    labels_file = "labels_enhance2.json"
    val = "val_enhance2.npz"
...
def parse(self, kwargs, print_=False):
    ...
    if self.gpu1:
        self.train_data_path = 'train_enhance2.npz'
        self.test_data_path = '%s.npz' % ('val_enhance2' if self.val else 'test_enhance2')
        self.labels_path = 'labels_enhance2.json'
    ...
    if self.floyd:
        ...
        self.test_data_path = '%s.npz' % ('val_enhance2' if self.val else 'test_enhance2')
        self.labels_path = 'labels_enhance2.json'
        self.embedding_path = 'char_embedding_enhance2.npz'
    if self.zhuge:
        self.train_data_path = 'train_enhance2.npz'
        self.test_data_path = '%s.npz' % ('val_enhance2' if self.val else 'test_enhance2')
        self.labels_path = 'labels_enhance2.json'
    ...
    ### word和char的长度不一样 ##
    if self.type_ == 'word':
        self.vocab_size = 127985  # num of words
    ...
    if self.type_ == 'char':
        self.vocab_size = 6940  # num of words
