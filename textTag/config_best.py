...
class Config(object):
    ...
    vocab_size = 154528  # num of words
    ...
    embedding_path = 'char_embedding_enhance.npz'  # Embedding
    train_data_path = 'train_enhance.npz'  # train
    labels_path = 'labels_enhance.json'  # labels
    test_data_path = 'test_enhance.npz'  # test
    ...
    model_num = 7
    data_root = ""
    labels_file = "labels_enhance.json"
    val = "val_enhance.npz"
...
def parse(self, kwargs, print_=False):
    ...
    if self.gpu1:
        self.train_data_path = 'train_enhance.npz'
        self.test_data_path = '%s.npz' % ('val_enhance' if self.val else 'test_enhance')
        self.labels_path = 'labels_enhance.json'
    ...
    if self.floyd:
        ...
        self.test_data_path = '%s.npz' % ('val_enhance' if self.val else 'test_enhance')
        self.labels_path = 'labels_enhance.json'
        self.embedding_path = 'char_embedding_enhance.npz'
    if self.zhuge:
        self.train_data_path = 'train_enhance.npz'
        self.test_data_path = '%s.npz' % ('val_enhance' if self.val else 'test_enhance')
        self.labels_path = 'labels_enhance.json'
    ...
    ### word和char的长度不一样 ##
    if self.type_ == 'word':
        self.vocab_size = 154528  # num of words
    ...
    if self.type_ == 'char':
        self.vocab_size = 7335  # num of words
