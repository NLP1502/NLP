...
class Config(object):
    ...
    vocab_size = 153344  # num of words
    ...
    embedding_path = 'char_embedding_gensim.npz'  # Embedding
    train_data_path = 'train_06.npz'  # train
    labels_path = 'labels_06.json'  # labels
    test_data_path = 'question_context_official_dev_set.npz'  # test
...
def parse(self, kwargs, print_=False):
    ...
    if self.gpu1:
        self.train_data_path = 'train_06.npz'
        self.test_data_path = '%s.npz' % ('val_06' if self.val else 'question_context_official_dev_set')
        self.labels_path = 'labels_06.json'
    ...
    if self.floyd:
        ...
        self.test_data_path = '%s.npz' % ('val_06' if self.val else 'question_context_official_dev_set')
        self.labels_path = 'labels_06.json'
        self.embedding_path = 'char_embedding_gensim.npz'
    if self.zhuge:
        self.train_data_path = 'train_06.npz'
        self.test_data_path = '%s.npz' % ('val_06' if self.val else 'question_context_official_dev_set')
        self.labels_path = 'labels_06.json'
    ...
    ### word和char的长度不一样 ##
    if self.type_ == 'word':
        self.vocab_size = 153344  # num of words
    ...
    if self.type_ == 'char':
        self.vocab_size = 7550  # num of words
